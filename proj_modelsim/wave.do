...
add wave -noupdate -expand -group PC -radix hexadecimal /TB_mips/DUV/DP/DUV/register_PC/data_in
add wave -noupdate -expand -group PC -radix hexadecimal /TB_mips/DUV/DP/DUV/register_PC/data_out
add wave -noupdate -expand -group PC /TB_mips/DUV/DP/DUV/register_PC/enable
...
add wave -noupdate -label GPIO_o_tb(R) -radix hexadecimal /TB_mips/GPIO_o_tb
