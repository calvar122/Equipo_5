...
add wave -noupdate -expand -group ALU -color {Lime Green} /TB_mips/DUV/ALUControl_w
add wave -noupdate -expand -group ALU -color {Lime Green} -label ALU_SrcA_i -radix hexadecimal /TB_mips/DUV/DP/DUV/M_ALU/a
add wave -noupdate -expand -group ALU -color {Lime Green} -label ALU_SrcB_i -radix hexadecimal /TB_mips/DUV/DP/DUV/M_ALU/b
add wave -noupdate -expand -group ALU -color {Lime Green} -label ALU_o -radix hexadecimal /TB_mips/DUV/DP/DUV/M_ALU/y
